		...
		<div class="flex">
			...
			<div class="flex-wrapper second">
				<h1 class = "title">
					...
					<div class="title-mask">
						<div class="word" bind:this={titleWord2Element}>Hachem</div>
					</div>
				</h1>
				<div class="occupation mask">
					<p class = "paragraph" bind:this={shortDetailsElement}>
						A professional dentist in Lebanon delivering precise, modern dental care for healthy, confident smiles.
					</p>
				</div>
